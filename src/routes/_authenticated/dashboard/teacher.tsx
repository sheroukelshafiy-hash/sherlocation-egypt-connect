...
export const Route = createFileRoute("/_authenticated/dashboard/teacher")({
  ...
  head: () => ({
    meta: [
      { title: "لوحة المدرس | شيرلوكيشن" },
      {
        name: "description",
        content: "لوحة المدرس على شيرلوكيشن: إدارة الحصص والملف التعليمي وطلبات الطلاب.",
      },
      { property: "og:title", content: "لوحة المدرس | شيرلوكيشن" },
      {
        property: "og:description",
        content: "أدر حصصك وملفك التعليمي وتابع طلبات الطلاب على شيرلوكيشن.",
      },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">{t("dashboardTeacherDesc")}</p>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <section className="rounded-2xl border border-border bg-card p-5">
            ...
            <dl className="mt-3 space-y-2 text-sm">
              ...
              <Row label={t("roleLabel")} value={t("roleTeacher")} />
            </dl>
          </section>

          <section className="flex flex-col justify-between rounded-2xl border border-border bg-card p-5">
            <div>
              <h2 className="text-sm font-bold text-card-foreground">{t("myClasses")}</h2>
