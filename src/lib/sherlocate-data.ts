export const GOVERNORATES: Record<string, string[]> = {
  ...
  قنا: ["قنا", "قوص", "نجع حمادي", "دشنا", "أبو تشت", "فرشوط", "قفط", "نقادة"],
  الأقصر: ["الأقصر", "إسنا", "أرمنت", "الطود", "البياضية"],
  أسوان: ["أسوان", "كوم أمبو", "إدفو", "دراو", "نصر النوبة", "أبو سمبل"],
  "البحر الأحمر": ["الغردقة", "سفاجا", "رأس غارب", "القصير", "مرسى علم"],
  "جنوب سيناء": ["شرم الشيخ", "دهب", "نويبع", "طابا", "أبو رديس", "الطور"],
  "شمال سيناء": ["العريش", "بئر العبد", "الشيخ زويد", "رفح", "نخل"],
  السويس: ["السويس", "عتاقة", "الجناين", "فيصل", "الأربعين"],
  الإسماعيلية: ["الإسماعيلية", "فايد", "القنطرة شرق", "القنطرة غرب", "التل الكبير", "أبو صوير"],
  "بورسعيد": ["بورسعيد", "بورفؤاد", "العرب", "الشرق", "الضواحي", "المناخ"],
  دمياط: ["دمياط", "دمياط الجديدة", "رأس البر", "فارسكور", "الزرقا", "كفر سعد", "كفر البطيخ"],
  "مطروح": ["مرسى مطروح", "الحمام", "العلمين", "الضبعة", "سيدي براني", "سيوة", "السلوم"],
